...
export const TrophyIcon = ({ size = 24, className = '', weight = 'fill' }) => (
...
export const CertificateIcon = ({ size = 24, className = '', weight = 'regular' }) => (
...
export const DownloadSimpleIcon = ({ size = 24, className = '', weight = 'bold' }) => (
...
export const ArrowRightIcon = ({ size = 24, className = '', weight = 'bold' }) => (
...
export const MagnifyingGlassIcon = ({ size = 24, className = '', weight = 'regular' }) => (
...
export const CheckCircleIcon = ({ size = 24, className = '', weight = 'fill' }) => (
...
export const XCircleIcon = ({ size = 24, className = '', weight = 'fill' }) => (
